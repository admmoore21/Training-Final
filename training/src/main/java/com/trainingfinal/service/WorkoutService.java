...
public interface WorkoutService {
	 ...
	 * @return
	 */
	Optional<Workout> createWorkout(String workoutName, Long clientId, 
	 ...
	 * @return
	 */
	Optional<Workout> updateWorkout(String workoutName, Long clientId, Double estimatedHrs, 
			BigDecimal price, String newWorkoutName, Long newClientId, 
